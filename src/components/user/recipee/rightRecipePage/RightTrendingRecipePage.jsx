...
const RightTrendingRecipePage = () => {
  return (
    <section className="space-y-5">
      <h3 className="text-lg font-semibold text-gray-800">Trending Recipes</h3>

      {recipes.slice(0, 3).map(({ id, img, title, calories, }) => (
...
export default RightTrendingRecipePage;
